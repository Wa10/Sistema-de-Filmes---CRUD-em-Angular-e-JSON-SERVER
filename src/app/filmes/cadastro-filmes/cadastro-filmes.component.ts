...
export class CadastroFilmesComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    if(this.id){
      ...
      this.criarFormulario(this.criarFomularioEmBranco());
    }
  ...
  private criarFomularioEmBranco(): Filme{
    return {
      id: null,
      titulo: null,
      dtLancamento: null,
  ...
  private salvar(filme: Filme): void {
    this.filmeService.salvar(filme).subscribe(
      ...
      () => {
        const config = {
          data: {
          titulo: 'Erro ao salvar o registros',
  ...
  private editar(filme: Filme): void {
    this.filmeService.editar(filme).subscribe(
      ...
      () => {
        const config = {
          data: {
          titulo: 'Erro ao editar o registros',
